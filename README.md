...
> When Arc mainnet ships, Argus will be live on day one — 1,090+ scans of battle-testing on testnet behind it. Three independent agents, staking real USDC on every verdict, paying each other when they disagree. The third eye is the tiebreaker. Always has been.
...
# Current stats (1,090+ scans, 93% consensus)
