#!/usr/bin/env node
// Argus MCP Server — Multi-Agent Security Oracle for Claude & ChatGPT
// Three independent agents (DeepSeek-V3, Claude, rules engine) analyze any EVM
// contract and return a consensus verdict. Every scan settles on-chain via x402.
import { McpServer } from "@modelcontextprotocol/sdk/server/mcp.js";
import { StdioServerTransport } from "@modelcontextprotocol/sdk/server/stdio.js";
import { z } from "zod";
import { scanContract, recentScans, agentElo, poolStats, ARGUS_API_URL } from "./api.js";
