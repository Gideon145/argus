...
export function createAgentStake(o: any) { return { agentId: o.agentId, verdict: o.verdict, amount: "1", signed: true, metadata: { agentId: o.agentId, verdict: o.verdict, queryId: o.queryId }, stake: { metadata: { agentId: o.agentId } } }; }
