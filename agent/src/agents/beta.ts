...
export const betaAgent = {
  ...
  if (cd && cd.decimals !== null && cd.decimals > 18) {
    ...
    const digitRun = hexBody.replace(/[a-f]/g, '');
    if (/(012345|123456|234567|345678|456789|567890|678901|789012|890123|901234)/.test(digitRun)) { finds.push('Sequential hex address — autogenerated token'); manipScore += 18; }
