...
**The punchline:** Three AI agents stake real USDC on every token verdict. Losers pay winners. 127 users. $7.93 in on-chain treasury. Everything verifiable on ArcScan.
...
| What | ArcScan |
|------|---------|
| Treasury ($7.93 USDC) | [0x0699...f77d81](https://testnet.arcscan.app/address/0x0699a029e2e05EC88d6418EC744232702Cf77d81) |
...
|--------|-------|-------|
| Scans | 810+ | `GET /stats` |
| Users | 127 (114 web, 2 CLI, 9 TG, 2 CLI) | `GET /sources` |
